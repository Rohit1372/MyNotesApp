...
import com.example.android.mynotes.databinding.NoteItemLayoutBinding
import com.example.android.mynotes.fragments.NoteFragmentDirections
            ...
            holder.apply {
                ...
                itemView.setOnClickListener {
                    val action = NoteFragmentDirections.actionNoteFragmentToSaveOrDeleteFragment()
                        .setNote(note)
                    val extras = FragmentNavigatorExtras(parent to "recycerView_${note.id}")
                    it.hideKeyboard()
